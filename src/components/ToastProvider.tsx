...
const BG_CLASSES = {
  [TOAST_TYPE.SUCCESS]: "bg-status-success-muted text-status-success-primary",
  [TOAST_TYPE.ERROR]: "bg-status-error-muted text-status-error-primary",
  [TOAST_TYPE.INFO]: "bg-status-info-muted text-status-info-primary",
};
