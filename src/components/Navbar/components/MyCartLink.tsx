...
const MyCartLink = () => {
  ...
  return (
    ...
    >
      ...
      <ShoppingCartFilledIcon className="fill-primary hidden h-5 w-5 group-hover:block" />
      ...
      {totalQuantity > 0 && (
        <span className="bg-primary text-s10-l14 text-surface-primary absolute -top-1 left-2 flex h-4 w-4 items-center justify-center rounded-full font-semibold">
          {totalQuantity}
        </span>
      )}
    </NavLink>
